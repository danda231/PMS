...
namespace PMS.Client.MainModule.ViewModels.Dialogs
{
    public class ModifyPasswordModel : IDialogAware, INotifyDataErrorInfo
    {
        ...
        {
            if(ErrorList.ContainsKey(propertyName)) return ErrorList[propertyName];
        ...
        public ModifyPasswordModel(IUserService userService)
        {
